...
class Ax360 extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function getSetsGroups($productId)
    {
        ...
        $collection->getSelect()->join(
            ...
            ['qty' => 'COUNT(i.id_360)', 'id_360set' => 'id_360set']
        );
    ...
    public function images360Json($productId, $extraGroups = [], $combination_id = false)
    {
    ...
    public function deleteImageAZcache($file)
    {
        ...
        // What to delete
        $arrDel = ['In' => true, 'Th' => true, 'tC' => true, 'mO' => true, 'Ti' => true];
